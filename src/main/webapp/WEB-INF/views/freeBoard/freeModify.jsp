       ...
       <script>
			...
			var listBtn = document.getElementById("listBtn");
              listBtn.onclick = function(){
            	  location.href = "freeList"; //목록화면 이동
              }
    	  ...
    	  /* 
    	  1. 폼에 데이터가 공백인지 확인처리
    	  2. 공백이 없으면 Controller에 freeUpdate요청으로 데이터 전송
    	  3. 컨트롤러에서는 반환유형을 int로 하는 update()메서드를 사용해서 정보를 수정
    	  4. 컨트롤러에서는 업데이트 성공시 "게시글이 수정이 정상처리 되었습니다."를 출력, 실패시 실패 출력(list로 redirect)
    	  5. 삭제도 처리해보기 
    	  */
